  ...
  function installFix(root) {
    ...
    if (!root.querySelector("style[" + STYLE_ATTRIBUTE + "]")) {
      ...
      style.textContent = [
        ...
        ".composer textarea{box-sizing:border-box!important;width:100%!important;min-height:36px!important;height:36px;max-height:112px!important;padding:8px 64px 8px 14px!important;border-radius:20px!important;line-height:18px!important;overflow-y:hidden;resize:none!important;scrollbar-width:thin!important}",
        ".branding{flex:0 0 auto!important;padding:5px 12px!important}",
        ".send-btn{position:absolute!important;right:24px!important;bottom:12px!important;box-sizing:border-box!important;width:26px!important;height:26px!important;min-width:26px!important;max-width:26px!important;padding:0!important;border-radius:999px!important;background:var(--chatbot-primary,#2563eb)!important;color:#fff!important;display:flex!important;align-items:center!important;justify-content:center!important;font-size:0!important;line-height:1!important;box-shadow:none!important}",
        ".send-btn::before{content:''!important;width:14px!important;height:14px!important;display:block!important;background-image:url('" + LIGHT_SEND_ICON + "')!important;background-repeat:no-repeat!important;background-position:center!important;background-size:14px 14px!important;transform:translateY(0)!important}",
        ...
        ".icon-btn.close-btn{border-radius:999px!important;background:rgba(255,255,255,.16)!important}"
      ].join("\n");
