  ...
  function installFix(root) {
    ...
    if (!root.querySelector("style[" + STYLE_ATTRIBUTE + "]")) {
      ...
      style.textContent = [
        ...
        ".send-btn{position:absolute!important;right:18px!important;bottom:11px!important;box-sizing:border-box!important;width:28px!important;height:28px!important;min-width:28px!important;max-width:28px!important;padding:0!important;border-radius:999px!important;background:var(--chatbot-primary,#2563eb)!important;color:#fff!important;display:flex!important;align-items:center!important;justify-content:center!important;font-size:0!important;line-height:1!important;box-shadow:none!important}",
