...
if (!Array.isArray(normalizedPrompts)) {
  ...
  function buildWidgetMarkup(root, chatPosition) {
    root.innerHTML = [
      ...
      '.starter-prompts { padding: 8px 16px; display: flex; flex-direction: column; flex-shrink: 0; gap: 6px; background: #f5f5f5; overflow-y: auto; scrollbar-width: thin; scrollbar-color: var(--chatbot-primary, #2563eb) transparent;max-height:140px }',
