(function () {
  ...
  var STYLE_ID = "chatbot-widget-exact-chatflow-layout-v2";
  ...
  function applyExactStyles(root) {
    ...
    style.textContent = [
      ...
      ".widget-root[data-open='true'] .launcher{background:var(--chatbot-primary,#1450d8)!important;font-size:0!important;color:#fff!important}",
      ".widget-root[data-open='true'] .launcher::before{content:'⌄'!important;display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;height:100%!important;color:#fff!important;font-size:34px!important;font-weight:700!important;line-height:.85!important;transform:translateY(-5px)!important}",
