...
if (!Array.isArray(normalizedPrompts)) {
  ...
  function buildWidgetMarkup(root, chatPosition) {
    root.innerHTML = [
      ...
      '.welcome-msg { padding: 8px 8px; width: 100%; max-width: 100% !important; max-height: 110px;  border-radius: 14px; align-items: flex-start; overflow-y: auto; margin-left: 0px; margin-right: 0px; }',
