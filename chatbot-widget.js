(function () {
  ...
  function buildWidgetMarkup(root, chatPosition) {
    root.innerHTML = [
      ...
      '@media (max-width: 767px) {.widget-root {right: 16px; left: auto; bottom: 16px; width: auto; align-items: flex-end;} .widget-root[data-open="true"] .panel {position: fixed;top: 0; left: 0; right: 0; bottom: 0; width: 100vw; height: 100vh; max-height: 100vh; border-radius: 0; z-index: 999999; } .widget-root[data-open="true"] .launcher { display: none;}}',
