(function () {
  ...
  function buildWidgetMarkup(root, chatPosition) {
    root.innerHTML = [
      ...
      '.starter-prompts { padding: 0 16px 10px; display: flex; flex-direction: column; gap: 6px; background: #f5f5f5; overflow-y: auto; scrollbar-width: thin; scrollbar-color: var(--chatbot-primary, #2563eb) transparent; }',
      ...
      '.prompt { width: fit-content; max-width: 85%; max-height:130px; background: white; border: 1px solid #e5e7eb; padding: 8px 12px; border-radius: 999px; font-size: 0.85em; cursor: pointer; color: inherit; text-align: left; }',
