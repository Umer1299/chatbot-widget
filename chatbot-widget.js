(function () {
  ...
  function buildWidgetMarkup(root, chatPosition) {
    root.innerHTML = [
      ...
      '@media (max-width: 767px) { .widget-root { left: 10; right: 10; bottom: 10; width: 100vw; align-items: stretch; gap: 0; } .widget-root[data-position="right"] { left: 10; right: 10; align-items: stretch; } .panel { width: 100vw; height: calc(100vh - env(safe-area-inset-bottom)); max-height: calc(100vh - env(safe-area-inset-bottom)); border-radius: 0; border-left: none; border-right: none; border-bottom: none; } .widget-root[data-open="true"] .launcher { display: none; } }',
